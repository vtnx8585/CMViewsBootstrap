<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CatalogoEstados.aspx.cs" Inherits="ClinicaMedica.Views.CatalogoEstados" %>
                    ...
                    <div class="panel-body">
                        <nav>
                            <ul class="nav nav-tabs" style="margin-bottom:2px;">
                                ...
                                <li role="presentation" class="active"><a id="aEstados" runat="server" href="~/Views/CatalogoEstados">Estados</a></li>
                            </ul>
                        </nav>
                        <div class="row">
                                    ...
                                    <div class="panel-body">                                           
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <asp:TextBox ID="txtNombreEstado" runat="server" CssClass="form-control" placeholder="Nombre de Estado"></asp:TextBox>                                                                                                                                         
                                            </div>
                                            <br />
                                            <div class="input-group">
                                                <div class="input-group-addon">Descripcion:</div>
                                                <asp:TextBox ID="txtDescripcionEstado" runat="server" CssClass="form-control" placeholder="Descripcion de Estado" TextMode="MultiLine"></asp:TextBox>  
                                                                                                                                                                                       
                                            </div>
                                            <br />
                                            <div style="float:right;">
                                                <asp:Button ID="btnGuardarNombreEstado" runat="server" Text="Guardar" CssClass="btn btn-default form-control" OnClick="btnGuardarNombreEstado_Click" />
                                            </div>                                                                                        
                                        </div>                                                                             
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="panel panel-default" style="height:600px;">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <br />                                        
                                        <asp:GridView ID="grdCatalogoEstado" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered table-condensed datatable table-hover" HeaderStyle-CssClass="btn-info">
                                            <Columns>
                                                <asp:BoundField HeaderText="Estado" DataField="dfEstado" ReadOnly="true" ItemStyle-Width="100px" />
